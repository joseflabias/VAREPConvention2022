...
import { View, ScrollView, TouchableWithoutFeedback, Platform } from 'react-native';
;
export default class HorizontalPicker extends PureComponent {
  constructor(props) {
    ...
    _defineProperty(this, "defaultDecelerationRate", Platform.OS == "ios" ? 50 : 0.9);
    ...
    this.paddingSide = 0;
    this.refScrollView = /*#__PURE__*/React.createRef();
    this.ignoreNextScroll = false;
  ...
  render() {
    ...
    }, props), data.map((item, index) => /*#__PURE__*/React.createElement(TouchableWithoutFeedback, {
      onPress: () => this.scrollToPosition(index),
      key: index
    }, /*#__PURE__*/React.createElement(View, null, renderItem(item, index)))));
  }
